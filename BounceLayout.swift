...
class BounceLayout: UICollectionViewLayout {
    ...
    override func prepareLayout() {
        ...
        let smallestDimension = min(collectionView!.frame.size.width, collectionView!.frame.size.height);
        spokeLength = (smallestDimension / 2) - 10.0 // Allow 10 points of padding on each side
